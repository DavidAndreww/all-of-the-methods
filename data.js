export const data = {
  arrayMethods: [
    ...
    },
    {
      name: 'Array.every( )',
      description:
        'Tests whether all elements in an array pass test implemented by provided function. Returns boolean value.',
      mutability: 'n/a',
      returnType: 'Boolean',
      editor: `
    ...
    },
    {
      name: 'Array.find( )',
      description:
        'Returns value of the first element that satisfies the provided testing function.',
      mutability: 'n/a',
      returnType: 'variant',
      editor: `
